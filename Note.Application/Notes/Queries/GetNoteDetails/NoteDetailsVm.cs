...
{
    public class NoteDetailsVm : IMapWith<Domain.Note>
    {
        ...
        {
            profile.CreateMap<Domain.Note, NoteDetailsVm>()
                ...
                .ForMember(noteVm => noteVm.EditDate, opt => opt.MapFrom(note => note.EditeDate));
        }
    }
}
